...
int main()
{
	...
	texturaCamionID =
		Shader::cargarBMP("texturas\\camion.bmp");
	...
	/*camion->inicializarVertexArray(posicionID, colorID,
		modeloID, vistaID, proyeccionID, coordenadaUVID,
		samplerImagenID, texturaCamionID);*/
